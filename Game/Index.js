        ...
        for (let i=0;i<amountOfPowerUPs;i++){
            if (
                ...
                if (PowerUP[i].typeOfPower === 1){
                    ...
                    powerUPSound.play();
                    if (amountOfShots+1+amountOfShots <= 6 + playerBulletCount){
                        amountOfShots= playerBulletCount + amountOfShots +1;
                        points+=100;
                    }
                    else{
                        points+=250;
    ...
    function drawLaser(){
        ...
        if (count >= amountOfShots+playerBulletCount){
            CoolDown = true;
        }
        else{
            CoolDown = false;
    ...
    function createBoss() {
        ...
        bossMode = true;
        Boss.Health = BossHealthBoost + Level*2;
